            ...
            <div class="parent">
                <div class="services__banner">
                    <div class="services__title-block">
                        ...
                        <div class="services__titles">
                            <h2 class="services__title services__title--white">Подвижные</h2>
                            <h2 class="services__title services__title--orange">разминки</h2>
                        </div>
                    </div>
                    <div class="services__info">
                        <h2 class="services__info-title">Откройте второе дыхание!</h2>
                        <p class="services__info-text">
                            Пробудите утомившийся класс, превратив перерыв на уроке в потрясающий
                ...
                <div class="warm-up">
                    <div class="warm-up__wrapper">
                        <img src="/images/servecies/hero-img1.png " alt="" class="warm-up__img" />
                        <div class="warm-up__info">
                            <h2 class="warm-up__info-title">Как устроена разминка?</h2>
                            <p class="warm-up__tex">
                                Подвижные разминки – поддерживают необходимую физическую активность
                                при помощи коротких динамических пауз во время урока. Геймплей,
                                построен на воспроизведении движений и интерактивном взаимодействии
                                с персонажем, выполняющим координирующую функцию.
                            </p>
                        ...
                        <div class="important__info">
                            ...
                            <div class="important__text-wrapper">
                                <p class="important__text">
                                    Дефицит двигательной активности – побочный эффект поведенческих
                                    паттернов школьной среды, приводящий к развитию психофизических
                                    недугов.
                                </p>
                                <p class="important__text">
                                    Большую часть дня школьники проводят сидя, провоцируя спад
                                    физического и эмоционального тонуса. Происходит взаимообогащение
                                    негативных факторов, формирующих привычки, ведущие к
                                    деструктивным изменениям костно-мышечной структуры и системы
                                    кровообращения
                                </p>
                                <p class="important__text">
                                    Совокупность этих показателей снижает сопротивляемость стрессу и
                                    создает трудности в самовыражении, формируя телесную
                                    замкнутость. Появляется апатия и гиперактивность, не позволяющие
                                    гармонично развиваться и оставаться академически успешными.
                                </p>
                            </div>
                        </div>
                        <img
                        ...
                        >
                            <div class="features__block-header">
                                ...
                                <div class="features__block-text">
                                    <span v-for="(title, index) in block.title" :key="index">{{
                                        title
                                    }}</span>
                                </div>
                            </div>
