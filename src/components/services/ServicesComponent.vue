        ...
        content: {
            ...
            featuresCardInfo: [
                ...
                },
                {
                    ...
                    text: 'Разминки удовлетворяют потребность в движении, игре и самовыражении, создавая атмосферу, способствующую социализации, правильному отдыху и формированию привычки к активному образу жизни'
                },
                {
                    id: 3,
                    img: '/images/servecies/features/icons/block-icon3.svg',
                    title: ['Успешный', 'урок'],
                    text: 'Повышается лояльность к хронометражу занятия,  формируется позитивная атмосфера, помогающая преодолению робости,  гиперактивности, усталости, что улучшает психофизический тонус '
                }
            ]
        }
    },
