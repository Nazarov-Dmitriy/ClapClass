...
const questions = ref([
    ...
    },
    {
        ...
        answer: [
            'Витрина кейсов – страница со списком всех кейсов сервиса.',
            'Направление – выкладка на витрине кейсов, объединяющая все разминки по выбранному формату (подвижные/ритм/когнитивные).',
